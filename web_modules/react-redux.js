import { b as bindActionCreators } from './common/redux-b60299f1.js';
import { c as createCommonjsModule, u as unwrapExports, i as invariant } from './common/browser-76b34471.js';
...
_ref) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    {
      invariant(reactIs_15(WrappedComponent), "You must pass a component to the function returned by " + (methodName + ". Instead received " + stringifyComponent(WrappedComponent)));
    }
